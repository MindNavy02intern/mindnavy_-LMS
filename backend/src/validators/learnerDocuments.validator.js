// Validation for the Learner Documents API
// (/api/admin/learners/:id/documents). Mirrors instructorDocuments.validator
// exactly — same contract, different type taxonomy.

const DOCUMENT_TYPES = new Set(["IDENTITY", "ENROLLMENT_AGREEMENT", "ACADEMIC_RECORD", "COMPLIANCE_FORM", "CERTIFICATE"]);

const DOCUMENT_STATUSES = new Set(["PENDING", "VERIFIED", "REJECTED", "ARCHIVED"]);

// Paperwork/scans only — no SVG (can carry script), same allow-list reasoning
// as instructorDocuments.validator.
