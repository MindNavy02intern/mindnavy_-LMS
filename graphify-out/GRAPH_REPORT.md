...
## Summary
- 1483 nodes · 2569 edges · 73 communities (70 shown, 3 thin omitted)
...
Cohesion: 0.17
Nodes (26): assignPermissionsToRole(), badRequest(), createPermission(), createRole(), deletePermission(), deleteRole(), duplicateRole(), getPermission() (+18 more)
...
Cohesion: 0.12
Nodes (15): adminLoginRateLimiter, adminUserActionRateLimiter, adminUsersAnalyticsRateLimiter, adminUsersImportRateLimiter, rateLimit, { adminUserActionRateLimiter }, express, { requireAdminAuth } (+7 more)
...
Cohesion: 0.04
Nodes (36): getAnalytics(), Props, Props, Props, ROLE_COLORS, ROLE_LABELS, Props, STATUS_COLORS (+28 more)

### Community 33 - "Community 33"
Cohesion: 0.06
Nodes (60): ACTION_TITLE, ACTION_TYPE, buildUserScope(), endOfUtcDay(), enumerateUtcDays(), getDashboardAdminWidgets(), getDashboardAnalytics(), getDashboardCore() (+52 more)
...
Cohesion: 0.12
Nodes (10): getUsers(), INPUT_BASE, LIMIT_OPTIONS, TabKey, TABS, UsersResponse, sk(), SkeletonRow() (+2 more)
...
Cohesion: 0.15
Nodes (18): APP_USER_ROLES, assignPermissionsToRole(), buildPagination(), createRole(), createRoleAuditLog(), deleteRole(), duplicateRole(), getRole() (+10 more)
...
Cohesion: 0.13
Nodes (8): getRolePageDetails(), formatDate(), LEVEL_BADGE, Props, RISK_BADGE, RoleDetailsDrawer(), STATUS_BADGE, Permission
...
Cohesion: 0.05
Nodes (37): ACCESS_LEVEL_OPTIONS, BRANCH_OPTIONS, DEPARTMENT_OPTIONS, ROLE_OPTIONS, CreateGroupModal(), EditGroupModal(), useOrgOptions(), useRoles() (+29 more)
...
Cohesion: 0.28
Nodes (6): getStoredToken(), getInvitations(), getUserDetails(), fetchAllUsers(), patchUserRole(), Props
...
## Knowledge Gaps
- **580 isolated node(s):** `name`, `version`, `description`, `main`, `start` (+575 more)
...
- **Why does `getStoredToken()` connect `Community 69` to `Community 32`, `Community 66`, `Community 2`, `Community 67`, `Community 34`, `Community 37`, `Community 35`, `Community 47`, `Community 48`, `Community 22`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 31`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `ToastType` connect `Community 67` to `Community 32`, `Community 34`, `Community 69`, `Community 59`, `Community 46`, `Community 49`, `Community 50`, `Community 27`, `Community 60`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `requireAdminAuth()` connect `Community 36` to `Community 5`, `Community 72`, `Community 9`, `Community 56`, `Community 57`, `Community 61`, `Community 30`?**
