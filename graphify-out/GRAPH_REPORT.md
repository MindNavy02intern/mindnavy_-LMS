# Graph Report - mindnavy LMS  (2026-06-20)

## Corpus Check
- 142 files · ~137,511 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1451 nodes · 2484 edges · 67 communities (64 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `824e1948`
...
- `adminResetPasswordController()` --calls--> `validateResetPasswordInput()`  [EXTRACTED]
  backend/src/controllers/admin.controller.js → backend/src/validators/adminAuth.validator.js
- `suspendUser()` --calls--> `validateUuidParam()`  [EXTRACTED]
...
Cohesion: 0.08
Nodes (48): adminForgotPasswordController(), adminGetTrustedDevicesController(), adminLoginController(), adminLogoutController(), adminMeController(), adminResetPasswordController(), adminRevokeTrustedDeviceController(), adminSendOtpController() (+40 more)
...
Cohesion: 0.11
Nodes (27): approveVerification(), bulkActionUsers(), deleteUser(), EMPTY_LIST_RESPONSE, exportUsers(), forceLogoutUser(), getUserDetails(), getUserMessagesList() (+19 more)
...
Cohesion: 0.07
Nodes (36): GroupMembersResponse, GroupResponse, groupsAPI, groupsFetch(), GroupsListResponse, getUsers(), Props, CreateGroupModal() (+28 more)
...
Cohesion: 0.21
Nodes (16): actionFetch(), approveVerification(), assignRole(), cancelInvitation(), createUser(), deleteUser(), DETAILS_MOCK, InvitationParams (+8 more)
...
Cohesion: 0.18
Nodes (10): adminLoginRateLimiter, adminUserActionRateLimiter, adminUsersAnalyticsRateLimiter, adminUsersImportRateLimiter, rateLimit, { adminUserActionRateLimiter }, express, { requireAdminAuth } (+2 more)
...
Cohesion: 0.06
Nodes (27): Props, Props, ActionResponse, ActivityItem, AssignRoleRequest, BulkActionError, BulkActionResponse, DailyTrendItem (+19 more)

### Community 33 - "Community 33"
Cohesion: 0.07
Nodes (53): ACTION_TITLE, ACTION_TYPE, getDashboardCore(), { getUsersAnalytics }, mapAuditToActivity(), prisma, approveVerification(), assertUserExists() (+45 more)
...
Cohesion: 0.21
Nodes (10): getCachedSession(), prisma, requireAdminAuth(), SESSION_CACHE, setCachedSession(), { adminUserActionRateLimiter }, ctrl, express (+2 more)

### Community 37 - "Community 37"
Cohesion: 0.11
Nodes (18): { adminUserActionRateLimiter }, { adminUserActionRateLimiter, adminUsersAnalyticsRateLimiter }, {
  ...
  getUserMessagesList,
  forceLogoutUser,
}, { getUsersList, getUserDetails } (+10 more)
...
Cohesion: 0.15
Nodes (10): AdminLayout(), LoginPage(), SignupPage(), TrustedDevicesPage(), VerifyDevicePage(), Props, ProtectedRoute(), useAuth() (+2 more)
...
Cohesion: 0.11
Nodes (10): getAnalytics(), Props, ROLE_COLORS, ROLE_LABELS, Props, STATUS_COLORS, STATUS_LABELS, AnalyticsResponse (+2 more)
...
Cohesion: 0.05
Nodes (42): apiFetch(), createRolePage(), deleteRolePage(), duplicateRolePage(), getRolePageDetails(), getRolesPageList(), getRolesPageStats(), RolesPageError (+34 more)
...
Cohesion: 0.18
Nodes (10): assignUserRole(), createUser(), suspendUser(), VALID_ROLES, VALID_STATUSES, VALID_VERIFICATION_STATES, validateAssignUserRoleInput(), validateCreateUserInput() (+2 more)

### Community 67 - "Community 67"
Cohesion: 0.10
Nodes (14): SuspendUserRequest, INPUT, Props, EXPIRY_OPTIONS, INPUT, LABEL, Props, ROLE_OPTIONS (+6 more)
...
## Knowledge Gaps
- **575 isolated node(s):** `name`, `version`, `description`, `main`, `start` (+570 more)
...
- **Why does `getStoredToken()` connect `Community 22` to `Community 2`, `Community 34`, `Community 35`, `Community 27`, `Community 47`, `Community 48`, `Community 49`, `Community 53`, `Community 24`, `Community 25`, `Community 26`, `Community 59`, `Community 31`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 45` to `Community 2`, `Community 6`, `Community 23`, `Community 55`, `Community 25`, `Community 62`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `requireAdminAuth()` connect `Community 36` to `Community 5`, `Community 37`, `Community 46`, `Community 19`, `Community 56`, `Community 57`, `Community 61`, `Community 30`?**
