  ...
  return (
    <div className="tw:rounded-xl tw:border tw:border-slate-200 tw:bg-white tw:p-5">
      ...
      <div className="tw:mt-3 tw:flex tw:items-center tw:gap-2">
        <div className="tw:h-[150px] tw:w-[150px] tw:shrink-0 tw:animate-pulse tw:rounded-full tw:bg-slate-100" />
...
export default function DistributionChart() {
  ...
  return (
    <div className="tw:rounded-xl tw:border tw:border-slate-200 tw:bg-white tw:p-5">
      ...
      <div className="tw:mt-3 tw:flex tw:items-center tw:gap-2">
        <div className="tw:relative tw:h-[150px] tw:w-[150px] tw:shrink-0">
          <ResponsiveContainer width="100%" height="100%">
            <PieChart>
              <Pie data={items} dataKey="count" nameKey="category" cx="50%" cy="50%" innerRadius={48} outerRadius={70} strokeWidth={2} stroke="#fff">
          ...
          <div className="tw:pointer-events-none tw:absolute tw:inset-0 tw:flex tw:flex-col tw:items-center tw:justify-center">
            <span className="tw:text-[22px] tw:font-bold tw:text-slate-900">{total}</span>
            <span className="tw:text-[11px] tw:text-slate-500">Total Courses</span>
          </div>
        </div>
