...
=======
      testMatch: /(dashboard|dashboard-kpis|roles|users|organization|groups|invitations|access-policies|stats-consistency|role-templates|user-role-assignments|learning-management|lm-overview|courses-tab|roles-permissions-deep-link|lm-deep-link|courses-invalidation|course-upload|course-builder|course-video-upload|course-settings|course-preview|course-submit|course-approval|categories|course-basic-info|learning-paths|quizzes|certificates|certificate-placeholders|live-sessions|enrollments|content-library|instructors|instructor-stats-cards|instructor-applications|instructor-panel-analytics|instructor-phase-b|instructor-phase-cd|instructor-auth|instructor-dashboard|instructor-courses|instructor-live-sessions|learners|competencies|reports|reports-schedule|finance|notifications|integrations|system-settings|user-courses-tab|user-more-tab|profile-page)(\.full)?\.spec\.ts/,
>>>>>>> bilal
=======
      testMatch: /(dashboard|dashboard-kpis|roles|users|organization|groups|invitations|access-policies|stats-consistency|role-templates|user-role-assignments|learning-management|lm-overview|courses-tab|roles-permissions-deep-link|lm-deep-link|courses-invalidation|course-upload|course-builder|course-video-upload|course-settings|course-preview|course-submit|course-approval|categories|course-basic-info|learning-paths|quizzes|certificates|certificate-placeholders|live-sessions|enrollments|content-library|instructors|instructor-stats-cards|instructor-applications|instructor-panel-analytics|instructor-phase-b|instructor-phase-cd|instructor-auth|instructor-dashboard|instructor-courses|instructor-course-builder-parity|instructor-live-sessions|instructor-students|instructor-phase5|instructor-phase6|learners|competencies|reports|reports-schedule|finance|notifications|integrations|system-settings|user-courses-tab|user-more-tab|profile-page|admin-message-thread)(\.full)?\.spec\.ts/,
>>>>>>> bilal
>>>>>>> 2888469b695197a0742107b731adf0b00049e3d3
